...
public class DefaultComponentMetadataProcessor implements ComponentMetadataProcessor {
    ...
    private final boolean onlyClassBasedRules;
    ...
    public DefaultComponentMetadataProcessor(Set<SpecRuleAction<? super ComponentMetadataDetails>> rules,
        ...
        this.onlyClassBasedRules = onlyClassBasedRules;
    ...
    private ModuleComponentResolveMetadata processClassRuleWithCaching(final ModuleComponentResolveMetadata metadata, MetadataResolutionContext metadataResolutionContext) {
        Action<ComponentMetadataContext> action = collectRulesAndCreateAction(classBasedRules, metadata.getModuleVersionId(), metadataResolutionContext.getInjectingInstantiator());
    ...
    private Action<ComponentMetadataContext> collectRulesAndCreateAction(Set<SpecConfigurableRule> rules, ModuleVersionIdentifier id, Instantiator instantiator) {
        if (rules.isEmpty()) {
